...
public class CoParentResponse {
    ...
    public static CoParentResponse from(PetCoParent coParent) {
        ...
        dto.setPetId(coParent.getPet().getId());
        dto.setPetName(coParent.getPet().getName());
        ...
        dto.setInvitedBy(coParent.getInvitedBy().getId());
        dto.setInvitedByName(coParent.getInvitedBy().getFullName());
        return dto;
    }
}
