...
class UserControllerTest {
    ...
    @Test void allEndpointsDelegateToService() {
        ...
        assertThat(controller.uploadAvatar(principal, file).getStatusCode()).isEqualTo(HttpStatus.OK);
        assertThat(controller.uploadCoverImage(principal, file).getStatusCode()).isEqualTo(HttpStatus.OK);
